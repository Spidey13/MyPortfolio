...
- **Codiey - Voice-First AI Coding Partner** *(FastAPI, WebSockets, TypeScript, React, Google Gemini)* -- Full-stack voice AI application with real-time bidirectional audio (<200ms latency), tree-sitter AST parsing with PageRank-based codebase intelligence, and live D3.js dependency graph visualization
- **ReMind - Human-like Memory for AI** *(Next.js, TypeScript, Node.js, Express, LangChain)* -- AI web application implementing temporal decay and memory reinforcement algorithms for human-like recall, with interactive heatmap visualizations and multi-factor confidence scoring to reduce hallucinations
- **Autonomous AI Research System** *(AWS Bedrock, Python, Multi-Agent Architecture, Streamlit)* -- Multi-agent system with 5 specialized agents orchestrating end-to-end literature reviews in minutes, featuring "Glass Box" transparency UI for real-time agent decision monitoring
- **StratSim - F1 Race Strategy Simulator** *(Python, CatBoost, Plotly/Dash, MLflow, Streamlit)* -- Multi-agent simulation platform with novel tire degradation algorithm improving pit-stop predictions by 18% and 0.05-second lap time accuracy using ML models trained on historical F1 telemetry
- **Prompt Optimization for Healthcare NLP** *(DSPy, MIPROv2, PyTorch, Hugging Face, BERTopic)* -- Perspective-aware summarization system using DSPy MIPROv2 automatic prompt optimization for medical Q&A, with multi-objective loss functions across 5 perspective categories

## Publications

- **An exploratory text-mining approach to analyzing DEI-related issues in eight leading architecture & design firms' publications** -- The Design Journal, 1-25 (2025)
- **An algorithmic approach for text summarization** -- IEEE International Conference for Advancement in Technology (ICONAT), 1-5 (2023)

## Education

- MS Data Science, Indiana University Bloomington (GPA: 3.6/4.0) (May 2025)
- BTech Computer Engineering, University of Mumbai (May 2023)

## Skills

- **Languages:** Python, TypeScript, JavaScript (ES6+), Java, C++, SQL
- **AI & GenAI:** RAG Pipelines, LLMs, LangChain, Prompt Engineering, PyTorch, Hugging Face Transformers, Google Gemini, spaCy
- **Backend & Cloud:** Node.js, Express.js, FastAPI, REST APIs, WebSockets, AWS (SageMaker, Lambda, Bedrock), Azure, Docker, Kubernetes
- **Data & Databases:** PostgreSQL, MongoDB, Redis, Pinecone, Pandas, Spark, Scikit-learn, XGBoost
- **Frontend & UI:** React.js, Next.js, Tailwind CSS, D3.js, Streamlit, Plotly/Dash
- **Architecture & DevOps:** Microservices, CI/CD (GitHub Actions), Event-Driven Architecture, MLOps, MLflow, System Design
